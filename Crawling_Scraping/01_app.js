...
// 이 파일 안에 node_modules/* 를 작성하면 그 안에 있는 모든
// 파일이 올라가지 않음
...
특정 도메인에서 어느범위까지 데이터 수집 허용이 가능한지 나온다.
...
User-agent: Ads-Naver
                로봇들은 데이터 수집 허용
Crawl-delay: 1
                로봇들이 데이터 수집할 때 서버에 부하를 주지 않게 하기 위해 최소 1초의 간격을 두어라
Allow: /n
Allow: /e
                /n으로 시작하거나 /e로 시작하는 특정 페이지 허용
